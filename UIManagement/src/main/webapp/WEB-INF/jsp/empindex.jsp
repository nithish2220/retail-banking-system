...
<div class="container" style="object-fit: cover;">
	<div class="jumbotron bg-cover"
		...
		<p></p>
		<p class="lead">
			<a class="btn btn-primary btn-lg" href="/elogin" role="button">Login</a>
		</p>
	</div>
</div>
...
<div class="component bg-light text-center" style="background-color='#e6ffff';">
