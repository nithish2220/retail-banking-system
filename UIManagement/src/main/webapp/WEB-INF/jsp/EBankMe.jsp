...
<div class="sticky-top bg-dark d-flex align-content-center">
	<a href="/inside" class="active nav-link text-white"><h1>Peoples' Bank</h1> <i><h5>-Let's
...
<div class="container card-group">
	<div class="row ps-4">
		<div class="col-sm-6">
			<div class="card">
				 <img class="card-img-top" src="images/create-customer.jpg" alt="Card image cap" >
				<div class="card-body">
		...
		<div class="col-sm-6">
			<div class="card">
				 <img class="card-img-top" src="images/ApproveLoan.png" alt="Card image cap"  height="430">
				<div class="card-body">
...
<div class="container card text-center">
	<img class="card-img-top" src="images/getAllCustomers.png" alt="Card image cap">
  <div class="card-body">
