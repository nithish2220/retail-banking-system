...
<div class="sticky-top bg-dark d-flex align-content-center">
	<a href="/cust" class="active nav-link text-white"><h1>Peoples' Bank</h1> <i><h5>-Let's
				make the change together...</h5></i></a>
	<ul class="align-content-center container nav nav-pills justify-content-end">
		<li class="nav-item"><a class="nav-link active" href="/custlogin">Login
				to my Account</a></li>
		<li class="nav-item"><a class="nav-link" href="/create-cust-acc">Create
				an Account</a></li>
	</ul>
</div>
...
<div class="container" style="object-fit: cover;">
	<i><h2 class="text-center">We always give value to our
			customers!!</h2></i> <br> <br>
	<h4>Welcome to Peoples' Bank Customers...</h4>
...
<div class="container" style="object-fit: cover;">
	<div class="jumbotron bg-cover"
		style="background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0.6) 50%, rgba(255, 255, 255, 0.9) 100%), url(images/feeedback.jpg)">
		...
		<p></p>
		<p class="lead">
			<a class="btn btn-primary btn-lg" href="/custlogin" role="button">Login</a>
		</p>
	</div>
</div>
